    ...
    do
    {
        ...
        switch (choice)
        {
            ...
            case '=': test+=test;
                        show_sequence(test);
                        break;
            case 'M': cout<<"Mean is " <<test.mean() <<endl;
                        break;
            case 'Z': cout<<"Sum is " <<summation(test) <<endl;
                    break;
            case 'D': cout<<"Stdev is " <<test.standardDeviation() <<endl;
                    break;
...
// Library facilities used: iostream.h
{
    ...
    cout << " ?   Print the result from the isitem( ) function" << endl;
...
// Library facilities used: iostream
{
    for (display.start( ); display.isitem( ); display.advance( ))
