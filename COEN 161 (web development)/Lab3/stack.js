...
class Stack {
    ...
    push(action) {
        ...
        this.actions.push(action); //actions is the array
        //actions.push(action);
    }
     ...
     * description 
     * Last element that was added is removed
     */
    pop() {
        if(this.size() === 0)
            return;
        let poppedAction = this.actions.pop();
        return poppedAction;
    }
     ...
     */
    size() {
        return this.actions.length; //this should work
    }
}